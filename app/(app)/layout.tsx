 ...
 *
 * It renders no chrome. The app bar and bottom nav belong to (complete),
 * because /profile-setup is a screen you pass through once and has no use for
 * navigation to places the guard would bounce you out of.
 */
